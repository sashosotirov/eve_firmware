...
// BASIC SETTINGS: select your board type, temperature sensor type, axis scaling, and endstop configurationboard
...
// Please choose the name from boards.h that matches your setup
  ...
  //#define MOTHERBOARD BOARD_MEGATRONICS_3
    #define MOTHERBOARD BOARD_RAMPS_13_EEB //Ext1,Ext2,Bed
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 2000, 500}  // 280 pignon emaritimmodels
...
#define DEFAULT_ACCELERATION          450  // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000   // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   450  // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves
